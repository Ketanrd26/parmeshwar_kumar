      ...
      <div className="cookies-parent parent">
        <div className="cookies cont">
          ...
          <p>
            ...
            Policy on the Service. The revised Policy will be effective 180 days
          ...
          <p>
            <span className="suggest-text">How We Use Your Information:</span>{" "}
          ...
          <p>
            <span className="suggest-text">How We Share Your Information:</span>{" "}
          ...
          <p>
            ...
            info@akkafoundation.in. We will respond to your request in
