    ...
    <>
      <div className="privacy-parent parent">
        <div className="privacy-cont cont">
          <h1 className="title">Privacy Policy for Parmeshwar Kumar</h1>
          <p>
            <span>
              {" "}
              At Parmeshwar Kumar, accessible from
              <a href="https://www.parmeshwarkumar.com/">https://www.parmeshwarkumar.com/</a>, one of our main priorities is the
              privacy of our visitors. This Privacy Policy document contains
              types of information that is collected and recorded by
              Parmeshwar Kumar and how we use it.
            </span>
            <span>
          ...
          <p>
            <span>
              {" "}
              Parmeshwar Kumar follows a standard procedure of using log files.
          ...
          <p>Parmeshwar Kumar does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
        </div>
      </div>
    </>
  );
